...
import { getAuth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup } from "https://www.gstatic.com/firebasejs/10.1.0/firebase-auth.js";
...
formButton.addEventListener("click", (e) => {
    ...
    signInWithEmailAndPassword(auth, emailInput.value, passwordInput.value).then((user) => {
